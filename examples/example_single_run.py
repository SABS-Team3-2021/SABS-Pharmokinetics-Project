...
pk.solve_iv_toFile('data/exampleIV.csv', 1, 1, 1, 1, 0, 0, doseFn, tSpan=8,
                   numIters=10000)
pk.solve_subcut_toFile('data/exampleSub.csv', 1, 1, 1, 1, 1,
...
pk.plot_single_file('data/exampleSub.csv')
